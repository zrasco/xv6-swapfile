...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -Wall -MD -ggdb -m32 -Werror
...
ULIB = ulib.o usys.o printf.o umalloc.o swapuser.o
...
EXTRA=\
	...
	zeb_test.c printf.c umalloc.c swap.c swapuser.o\
